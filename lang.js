...
(function () {
  ...
  var T = {
    en: {
      ...
      'nav.discord':'Discord','nav.faq':'FAQ','nav.store':'Store','nav.login':'Log in','nav.admin':'Admin',
      ...
      'capes.filter_label':'Filter:','capes.wearers':'wearers',
      'capes.filter_all':'All Capes','capes.filter_rare':'Rare Only','capes.filter_common':'Common',
      'capes.sort_label':'Sort:','capes.sort_wearers':'Most Wearers','capes.sort_name':'Name A–Z','capes.sort_rare':'Rarest First',
    ...
    es: {
      ...
      'nav.discord':'Discord','nav.faq':'Preguntas','nav.store':'Tienda','nav.login':'Iniciar sesión','nav.admin':'Admin',
      ...
      'capes.filter_label':'Filtrar:','capes.wearers':'portadores','capes.filter_all':'Todas','capes.filter_rare':'Raras','capes.filter_common':'Comunes',
      'capes.sort_label':'Ordenar:','capes.sort_wearers':'Más Portadores','capes.sort_name':'Nombre A–Z','capes.sort_rare':'Más Raras Primero',
    ...
    fr: {
      ...
      'nav.discord':'Discord','nav.faq':'FAQ','nav.store':'Boutique','nav.login':'Se connecter','nav.admin':'Admin',
      ...
      'capes.filter_label':'Filtrer :','capes.wearers':'porteurs','capes.filter_all':'Toutes','capes.filter_rare':'Rares','capes.filter_common':'Communes',
      'capes.sort_label':'Trier :','capes.sort_wearers':'Plus de Porteurs','capes.sort_name':'Nom A–Z','capes.sort_rare':'Les Plus Rares D\'abord',
    ...
    de: {
      ...
      'nav.discord':'Discord','nav.faq':'FAQ','nav.store':'Shop','nav.login':'Anmelden','nav.admin':'Admin',
      ...
      'capes.filter_label':'Filter:','capes.wearers':'Träger','capes.filter_all':'Alle','capes.filter_rare':'Selten','capes.filter_common':'Häufig',
      'capes.sort_label':'Sortieren:','capes.sort_wearers':'Meiste Träger','capes.sort_name':'Name A–Z','capes.sort_rare':'Seltenste Zuerst',
    ...
    pt: {
      ...
      'nav.discord':'Discord','nav.faq':'FAQ','nav.store':'Loja','nav.login':'Entrar','nav.admin':'Admin',
      ...
      'capes.filter_label':'Filtrar:','capes.wearers':'usuários','capes.filter_all':'Todas','capes.filter_rare':'Raras','capes.filter_common':'Comuns',
      'capes.sort_label':'Ordenar:','capes.sort_wearers':'Mais Usuários','capes.sort_name':'Nome A–Z','capes.sort_rare':'Mais Raras Primeiro',
    ...
    ru: {
      ...
      'nav.discord':'Discord','nav.faq':'FAQ','nav.store':'Магазин','nav.login':'Войти','nav.admin':'Админ',
      ...
      'capes.filter_label':'Фильтр:','capes.wearers':'носителей','capes.filter_all':'Все','capes.filter_rare':'Редкие','capes.filter_common':'Обычные',
      'capes.sort_label':'Сортировка:','capes.sort_wearers':'Больше Носителей','capes.sort_name':'Имя А–Я','capes.sort_rare':'Сначала Редкие',
    ...
    zh: {
      ...
      'nav.discord':'Discord','nav.faq':'常见问题','nav.store':'商城','nav.login':'登录','nav.admin':'管理',
      'nav.search':'搜索玩家...',
      ...
      'capes.filter_label':'筛选:','capes.wearers':'使用者','capes.filter_all':'全部','capes.filter_rare':'稀有','capes.filter_common':'普通',
      'capes.sort_label':'排序:','capes.sort_wearers':'使用者最多','capes.sort_name':'名称 A–Z','capes.sort_rare':'最稀有优先',
    ...
    ja: {
      ...
      'nav.discord':'Discord','nav.faq':'よくある質問','nav.store':'ストア','nav.login':'ログイン','nav.admin':'管理',
      'nav.search':'プレイヤーを検索...',
      ...
      'capes.filter_label':'フィルター:','capes.wearers':'装着者','capes.filter_all':'すべて','capes.filter_rare':'レア','capes.filter_common':'一般',
      'capes.sort_label':'並べ替え:','capes.sort_wearers':'装着者数順','capes.sort_name':'名前 A–Z','capes.sort_rare':'希少順',
